# Development stage 1:
# This box packages all functions use to operate game 2048:
'''
2048 can be seen as 3 steps, '2' generation, movement, and result judgement. The game will repeat these steps
until the result judgement says the game is lost or won.

The functions below will do these three things.
'''
# 2 generator
import random as rd
import numpy as np
...
def generator(status, mat):
    ...
    if status == 'start':
        ...
        return mat
    if status == 'stop':
        return 'no movement'  # for test purposes


# movement functions are defined below:
# in the movement funtions series, I would define a reverse and a transpose funtion
